...
@Mapper
public abstract class ManufacturerMapper implements HardwareMapper {
    ...
    public abstract NameableDto toDto(Manufacturer entity);

    @Mapping(target = "id", ignore = true)
    @Mapping(target = "createdAt", ignore = true)
    @Mapping(target = "modifiedAt", ignore = true)
    public abstract Manufacturer fromDto(NameableRequestDto dto);
}
